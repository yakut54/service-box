...
class StaffController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Не $existingUser->shop (hasOne — при нескольких магазинах у
        // владельца сети вернул бы произвольный один и мог случайно
        // пропустить). Настоящая причина запрета не в количестве магазинов,
        // а в том, что owner-путь в SetShopFromAuth всегда выигрывает у
        // staff-пути: владелец чужого магазина, приняв это приглашение,
        // всё равно продолжит попадать в свой магазин — приглашение
        // окажется мёртвым. is_chain_owner добавлен отдельно: владелец сети
        // без единой точки под shops()->exists() не попадёт, но он всё
        // равно не сотрудник, которого можно позвать в чужую точку.
