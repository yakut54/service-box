...
import type { WidgetProduct, WidgetView } from '@/types'
...
<template>
  <div class="sb-widget" ref="widgetEl" data-theme="light">
    <div
        class="sb-overlay"
        :class="{
    ...
    >
      ...
      <div class="sb-body">
        <WidgetSidebar
          ...
          :active-sidebar-category="activeSidebarCategory"
          :open="sidebarOpen"
          :cart-open="cartOpen"
          @navigate="navigate"
          @cart-back="handleCartBack"
