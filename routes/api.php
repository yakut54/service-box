...
Route::prefix('superadmin')->middleware(['auth:sanctum', 'superadmin'])->group(function () {
    ...
    // Owners (chain owner toggle)
    Route::get('/owners',                     [SuperadminOwnerController::class, 'index']);
    Route::put('/owners/{user}/chain',        [SuperadminOwnerController::class, 'toggleChainOwner']);
});
