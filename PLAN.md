...
| М3.6 | Кнопки в боте: "Клиент пришёл" / "Не пришёл" — Telegram | ⬜ в очереди |
...
| М4.2 | Письмо-приглашение: показывать роль (мастер/администратор) и что ждёт после входа | ⬜ в очереди |
