...
<template>
  <div class="card group hover:shadow-md transition-shadow flex flex-col">
    ...
    <div class="flex gap-2 mt-auto">
      ...
      <button @click="emit('delete', product.id)" class="btn-ghost btn-sm text-red-600 hover:bg-red-50">
