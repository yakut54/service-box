...
onMounted(async () => {
  try {
    ...
    connected.value = data.telegram_connected
  } catch {}
})
...
<template>
  <div class="card">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Мгновенные уведомления о новых записях прямо в Telegram.</p>
