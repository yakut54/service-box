...
<body>
  <div class="wrap">
    ...
    <div class="body">
      <p>Для вас создан магазин <strong>{{ $shopName }}</strong> в {{ config('app.name') }}, аккаунт — <strong>{{ $userEmail }}</strong>.</p>
      <p>Нажмите кнопку ниже, чтобы задать пароль и войти:</p>
      <a href="{{ $resetUrl }}" class="btn">Задать пароль</a>
      <p class="note">Ссылка действует <strong>60 минут</strong>. Если письмо пришло по ошибке — просто проигнорируйте его.</p>
